...
public class vMeleeManager : MonoBehaviour
{
   ...
   // [HideInInspector]
    ...
    public void EnableDamage(AttackObject attackObject)
    {
        ...
        meleeWeapon.damage.activeRagdoll = attackObject.activeRagdoll;
...
public class AttackObject
{
    ...
    public AttackObject(HitboxFrom hitboxFrom, int recoil_ID, float damageMultiplier, bool value, bool activeRagdoll, string attackName = "")
    {
